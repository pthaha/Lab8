describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    await button.click();
    let inner = await button.getProperty('innerText');
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    const value=await inner.jsonValue();
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (const item of prodItems) {
      ...
      const valu = await text.jsonValue();
      expect(valu).toBe("Remove from Cart");
    }
    const count = await page.$("#cart-count");
    const inner= await count.getProperty("innerText");
    const value=await inner.jsonValue();
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (const item of prodItems) {
      const shadow = await item.getProperty('shadowRoot');
      const button = await shadow.$('button');
      const inner = await button.getProperty('innerText');
      const value = await inner.jsonValue();
